...
export class VideoInputSection extends BaseComponent<HTMLElement> implements InputSection {
  ...
  getAllInputData() {
    ...
    const mediaURL = this.element.querySelector("#mediaURL")! as HTMLInputElement;
    if (!(title.value && description.value && saleSite.value && mediaURL.value)) {
